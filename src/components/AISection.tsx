...
export function AISection() {
  return (
    <section className="relative overflow-hidden border-t border-hairline/60 bg-navy/40 py-24 sm:py-32">
            ...
            <div className="relative rounded-3xl border border-hairline bg-ink/60 p-6 backdrop-blur-sm sm:p-9">
              ...
              <div className="mt-6 grid grid-cols-3 gap-px overflow-hidden rounded-xl border border-hairline bg-hairline/50">
                {[
                  ...
                  <div key={m.k} className="min-w-0 bg-surface/70 px-1.5 py-3.5 text-center sm:px-3 sm:py-4">
                    <p className="break-words font-heading text-[0.74rem] font-medium leading-tight text-ivory sm:text-[0.95rem]">{m.v}</p>
                    <p className="mt-1 break-words font-mono text-[0.5rem] uppercase leading-tight tracking-[0.1em] text-slateish/70 sm:text-[0.58rem] sm:tracking-[0.16em]">
                      {m.k}
                    </p>
                  </div>
                ))}
