...
export function About() {
  return (
    <section  className="relative border-t border-hairline/60 bg-navy/30 py-24 sm:py-32">
          ...
          <div>
            ...
            <Reveal delay={0.1}>
              <div className="mt-8 space-y-5 max-w-2xl">
                <p className="text-[1rem] leading-relaxed text-slateish sm:text-[1.08rem]">
                ...
                <p className="text-[0.96rem] leading-relaxed text-slateish">
            ...
            <div className="mt-12 space-y-3">
              ...
              <Reveal key={pillar.title} delay={0.1 + i * 0.08}>
                  <div className="group flex items-start gap-4 rounded-2xl border border-hairline bg-surface/40 p-5 transition-all duration-500 hover:border-brand-blue/40 hover:bg-surface/70">
                    <span
                    className="mt-0.5 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-hairline bg-ink/70"
                    style={{ boxShadow: `inset 0 0 20px -12px ${pillar.color}` }}>
                    
                      <pillar.icon className="h-4 w-4" style={{ color: pillar.color }} strokeWidth={1.7} />
                    </span>
                    <div>
                      <h3 className="font-heading text-[1rem] font-medium text-ivory">
                        {pillar.title}
                      </h3>
                      <p className="mt-1.5 text-[0.88rem] leading-relaxed text-slateish">
                        {pillar.copy}
                      </p>
                    </div>
                  </div>
          ...
          <Reveal delay={0.2}>
            <div className="relative lg:sticky lg:top-28">
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <div className="col-span-2 overflow-hidden rounded-3xl border border-hairline bg-ink/70 p-7">
                  <p className="font-mono text-[0.62rem] uppercase tracking-[0.26em] text-slateish/60">
                    the throughline
                  </p>
                  <div className="mt-6 space-y-4">
                    ...
                    <div key={word} className="flex items-center gap-4">
                        ...
                        i === 3 ? 'ivx-text-gradient' : 'text-ivory'}`
                        }>
                ...
                <div className="rounded-3xl border border-hairline bg-surface/50 p-6">
                  <p className="font-heading text-[1.15rem] font-medium text-ivory">Product-minded</p>
                  <p className="mt-1.5 text-[0.82rem] leading-relaxed text-slateish">
                    Design and engineering under one roof
                  </p>
                </div>
                <div className="rounded-3xl border border-hairline bg-surface/50 p-6">
                  <p className="font-heading text-[1.15rem] font-medium text-ivory">Cross-industry</p>
                  <p className="mt-1.5 text-[0.82rem] leading-relaxed text-slateish">
                    From fintech to healthcare and beyond
                  </p>
                </div>
                <div className="col-span-2 rounded-3xl border border-hairline bg-surface/50 p-6">
                  <p className="text-[0.9rem] leading-relaxed text-slateish">
