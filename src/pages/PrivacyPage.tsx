...
export function PrivacyPage() {
  return (
    <>
      <Seo path="/privacy" title="Privacy Policy" description="How Ideavix handles information you share with us." />
        ...
        <div className="mx-auto w-full max-w-[860px] px-5 sm:px-8">
          <article className="prose-docs mt-10 space-y-8 text-[0.95rem] leading-relaxed text-slateish">
            ...
            <section>
              ...
              <p className="mt-3">Contact submissions are retained for as long as necessary to fulfill the purposes outlined in this policy, unless a longer retention period is required by law. You may request deletion of your data by contacting us.</p>
            </section>
            <section>
              <h2 className="font-heading text-[1.25rem] font-semibold text-ivory">Your rights</h2>
              <p className="mt-3">Depending on your jurisdiction, you may have rights to access, correct or delete your information. Contact us at {company.email} to exercise them.</p>
            </section>
            <section>
              <h2 className="font-heading text-[1.25rem] font-semibold text-ivory">Contact</h2>
              <p className="mt-3">Questions about this policy? Email {company.email}.</p>
